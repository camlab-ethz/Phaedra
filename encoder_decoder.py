"""Encoder-Decoder Architecture for Phaedra.

Implements a convolutional encoder-decoder architecture with:
- ResNet blocks with GroupNorm
- Self-attention layers at specified resolutions
- Configurable channel multipliers for multi-scale processing
...
class AttnBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        # Reshape to (batch, heads, seq_len, dim) where heads=1
        ...
        h_ = h_.squeeze(1).permute(0, 2, 1).reshape(b, c, h, w)
